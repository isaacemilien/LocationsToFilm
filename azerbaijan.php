  ...
  <div class="container-fluid">
      ...
      <div class="row bg h-100" style="background-image: url('imgs/azer_03.jpg')">
        <div class="col-6 my-5 bg-dark p-5 m-5" style="--bs-bg-opacity: .5;">
          ...
          <p class=" text-light ">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sed hic, dolorum fugiat, sunt illo nihil architecto maiores ullam nemo excepturi culpa tenetur quos fuga blanditiis voluptatum laborum error eveniet dolore?
          </p>
        </div>
      </div>
    </div>
            ...
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    <button onclick="window.location.href='./commercial-properties.html'" type="button" class="btn btn-sm btn-primary">View</button>
                  </div>
                </div>
              </div>
            </div>
